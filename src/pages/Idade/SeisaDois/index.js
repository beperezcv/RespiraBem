...
import logo from './logo-roxa.png';
import icon from './iconlogoroxa.png';
import seringa from './seringaverdees.png';
import maos from './maosroxa.png';
import torneira from './torneirarosa.png';
            ...
            <LinearGradient colors={['#9C5DFC', '#47E9CB']} style={styles.gradient}>
                ...
                <View style={styles.retangulo}>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => navigation.navigate('MateriaisSeisaDois')}
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => navigation.navigate('ComofazerSeisaDois')}
                        accessibilityLabel="Comofazer">
                        <Image source={maos} style={styles.logobotao} />
                        <Text style={styles.botaoTextoRoxo}>Como fazer a higiene nasal</Text>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity
                        ...
                        <Text style={styles.botaoTextoRosa}>Como higienizar os dispositivos</Text>
                    </TouchableOpacity>
                </View>
