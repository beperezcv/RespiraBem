...
import icon from './maosrosa.png';

export default function ComofazerDois() {
            ...
            <LinearGradient colors={['#CE447B', '#9C5DFC']} style={styles.gradient}>
                ...
                <View style={styles.retangulo}>
                    ...
                    <View style={styles.tabela}>
                        ...
                        <Text style={styles.tabelaTexto}>3 a 20 ml por vez</Text>
                    </View>
                    <View style={styles.tabela}>
                        <Text style={styles.tabelaTexto}>Spray de jato contínuo</Text>
                        <Text style={styles.tabelaTexto}>De 3 a 10 segundos</Text>
                    </View>
                    <View style={styles.tabela}>
                        <Text style={styles.tabelaTexto}>Garrafinha</Text>
                        <Text style={styles.tabelaTexto}>Tolerância da criança</Text>
                    </View>

                    <Video
                        source={require('./videodois.mp4')} 
                        style={styles.video}
                        useNativeControls
                        resizeMode="contain"
                        isLooping
