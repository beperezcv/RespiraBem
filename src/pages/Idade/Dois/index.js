...
import icon from './iconlogorosa.png';
import seringa from './seringaroxa.png';
import maos from './maosrosa.png';
import torneira from './torneiralaranja.png';
            ...
            <LinearGradient colors={['#CE447B', '#9C5DFC']} style={styles.gradient}>
                ...
                <View style={styles.retangulo}>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => navigation.navigate('MateriaisDois')}
                        accessibilityLabel="Materiais">
                        <Image source={seringa} style={styles.logobotao} />
                        <Text style={styles.botaoTextoRoxo}>Materiais Necessários</Text>
                    </TouchableOpacity>

                    <TouchableOpacity
                        style={[styles.botao, styles.botaoRosa]}
                        onPress={() => navigation.navigate('ComofazerDois')}
                        accessibilityLabel="Comofazer">
                        <Image source={maos} style={styles.logobotao} />
                        <Text style={styles.botaoTextoRosa}>Como fazer a higiene nasal</Text>
                    </TouchableOpacity>

                    <TouchableOpacity
                        style={[styles.botao, styles.botaoLaranja]}
                        ...
                        <Text style={styles.botaoTextoLaranja}>Como higienizar os dispositivos</Text>
                    </TouchableOpacity>
                </View>
